...
# Not to share the confidential data due to this entered input is not to display using -s

echo "Please enter the password for the Person 5:"
read -s PASSWORD5

echo "Password has been set for $PERSON5"